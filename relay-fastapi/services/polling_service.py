"""ШИМ. Канонический код: /root/relay/services/polling_service.py
...
Загружаем канонический файл ПО ПУТИ, а не через import_module: имя services.polling_service
...
_spec = _u.spec_from_file_location("_canon_polling_service", _os.path.join(_RELAY, "services", "polling_service.py"))
