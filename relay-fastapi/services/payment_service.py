"""ШИМ. Канонический код: /root/relay/services/payment_service.py
...
Загружаем канонический файл ПО ПУТИ, а не через import_module: имя services.payment_service
...
_spec = _u.spec_from_file_location("_canon_payment_service", _os.path.join(_RELAY, "services", "payment_service.py"))
