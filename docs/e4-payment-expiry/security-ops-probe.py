...
OLD_SOURCE=subprocess.run(['git','show','73115816d41de5963d395aeaee841caf833dcdc2:relay-fastapi/main.py'],cwd=ROOT,capture_output=True,check=True).stdout
cases=[]
...
for scenario in ['normal-round-trip','before-publication','after-publication','restart-acknowledgement-lost']:
    with tempfile.TemporaryDirectory(prefix='expiry-security-ops-') as temporary:
...
print(json.dumps({'schemaVersion':'e4-payment-expiry-independent-ops-probe.v1','result':'PASS',
