...
`E4 / WEBSITE_SWAP_ACTION_REVIEW / show provider quote and explicit review before swap creation`
...
That connection-lifetime prerequisite is now resolved above. Previously,after
