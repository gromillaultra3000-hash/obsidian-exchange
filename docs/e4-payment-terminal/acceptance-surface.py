...
baseline = ROOT / 'output/manual/e4-payment-terminal-20260908/baseline/relay-fastapi/main.py'
...
report = {'schemaVersion': 'e4-payment-terminal-acceptance-surface.v1', 'result': 'PASS',
